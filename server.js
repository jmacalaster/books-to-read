...
mongoose.connect(
 process.env.MONGODB_URI || "mongodb://localhost/books-to-read",
 {
   useMongoClient: true
 }
);
...
app.get("/scrape", function(req, res) {
  ...
  axios.get("https://www.manning.com/catalog/sort/sort-by-date").then(function(response) {
